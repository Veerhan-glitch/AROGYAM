...
function loadDoctorDashboard() {
  ...
  appointmentsList.innerHTML = appointments.length ? 
    `<div class="dashboard-preview">
      ...
      <button class="action-btn" onclick="window.location.href='pages/doctor/appointments.html'">View Appointments</button>
    </div>` : 
    `<div class="dashboard-preview">
      <p>No appointments for today</p>
      <button class="action-btn" onclick="window.location.href='pages/doctor/appointments.html'">Manage Schedule</button>
    </div>`;

  // Update patient list for prescription
  const patientSelect = document.getElementById('patientSelect');
  const patients = JSON.parse(localStorage.getItem('users')).filter(u => u.userType === 'user');
